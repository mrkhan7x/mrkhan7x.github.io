...
# File: D:\DA + DE\PYTHON_PROJECTS\06_diabetes_predictor\run_integration_tests.py
import subprocess
import time
import sys
import os
...
def main():
    ...
    server_process = subprocess.Popen(
        ...
        cwd=proj_dir,
        stdout=subprocess.DEVNULL,  # Discard stdout/stderr to prevent buffering blocks
